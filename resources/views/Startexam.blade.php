                                            ...
                                            @foreach ($question as $value)
                                                ...
                                                @endif
                                                    <div class="card">
                                                        ...
                                                        @if ($value->image != NULL)
	                                                        <div>
	                                                        <img class="img-responsive center-block" src="http://www.allexamcorner.org/aecapp/public/images/{!!$value->image!!}">
	                                                        </div>
                                                        @endif
                                                        </div>
                                                            ...
                                                            <form action="#" >
                                                                <p class="col-sm-12">
                                                                    ...
                                                                    @if ($value->image_A != NULL)
                                                                        <div>
                                                                            <img class="img-responsive center-block" style="max-width: 250px; max-height: 359px;"  src="http://www.allexamcorner.org/aecapp/public/images/{!!$value->image_A!!}">
                                                                        </div>
                                                                    @endif
                                                                </p>
                                                                <p class="col-sm-12">
                                                                    ...
                                                                    @if ($value->image_B != NULL)
                                                                        <div>
                                                                            <img class="img-responsive center-block" style="max-width: 250px; max-height: 359px;"  src="http://www.allexamcorner.org/aecapp/public/images/{!!$value->image_B!!}">
                                                                        </div>
                                                                    @endif
                                                                </p>
                                                                <p class="col-sm-12">
                                                                    ...
                                                                    @if ($value->image_C != NULL)
                                                                        <div>
                                                                            <img class="img-responsive center-block" style="max-width: 250px; max-height: 359px;" src="http://www.allexamcorner.org/aecapp/public/images/{!!$value->image_C!!}">
                                                                        </div>
                                                                    @endif
                                                                </p>
                                                                <p class="col-sm-12">
                                                                    ...
                                                                    @if ($value->image_D != NULL)
                                                                        <div>
                                                                            <img style="max-width: 250px; max-height: 359px;" class="img-responsive center-block"  src="http://www.allexamcorner.org/aecapp/public/images/{!!$value->image_D!!}">
                                                                        </div>
                                                                    @endif
                                                                </p>
                                                            </form>
                                                        ...
                                                        <div class="row">
                                                                <div class="col-xs-12 text-center" style="margin-bottom:20px;">
                                                                    @if ($no > 2)
                                                                    <button type="button" onclick="Previous('{{$no-1}}',{{$question}})" class="btn btn-outline-warning select-button">Previous</button>
                                                                    @endif
                                                                    <button type="button" onclick="Save('{{$no-1}}',{{$question}})" class="btn btn-outline-success select-button">Save & Next</button>
                                                                    <button type="button" onclick="Reminder('{{$no-1}}',{{$question}})" class="btn btn-outline-info select-button">Reminder</button>
                                                                   @if ($no <= sizeof($question))
                                                                    <button type="button"  onclick="Skip('{{$no-1}}',{{$question}})" class="btn btn-outline-danger select-button">Skip</button>
                                                                    @endif
