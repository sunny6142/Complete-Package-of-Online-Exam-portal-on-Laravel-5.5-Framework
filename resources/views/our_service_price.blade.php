...
<body style="background: #eeeccc;">
      <div class="row text-center">
        <h2>Start Your Website @ Just </h2>       
      </div>
      <div class="row text-center">
        <a href="http://allexamcorner.com/#contact"> Limited Time Offer</a>       
      </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">        
                    <div class="price_table_container">
                        ...
                        <div class="price_table_body">
                            <div class="price_table_row cost warning-bg"><strong>Rs 5000</strong><span> / Save 50%</span></div>
                            <div class="price_table_row">Rs 99 / month Hosting</div>
                            <div class="price_table_row">30 GB Storage</div>
                            <div class="price_table_row">Unmetered bandwidth</div>
                            <div class="price_table_row">Full Time Support</div>      
                            <div class="price_table_row">Rs 99 / month Domain with annual plan</div>                                          
                        </div>
                        <a href="http://allexamcorner.com/#contact" class="btn btn-warning btn-lg btn-block">Contact Us</a>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">
                    ...
                    <div class="price_table_container">
                        ...
                        <div class="price_table_body">
                            <div class="price_table_row cost primary-bg"><strong>Rs 7,000</strong><span> / Save 50%</span></div>
                            <div class="price_table_row">1 Websites</div>
                            <div class="price_table_row">Rs 199 / month Hosting</div>
                            <div class="price_table_row">100 GB Storage</div>
                            <div class="price_table_row">Unmetered  GB Bandwidth</div>
                            <div class="price_table_row">Free domain* with annual plan</div>
                            <div class="price_table_row">Free Personal/Business Email - 1st year</div>
                            <div class="price_table_row">Full Time Support</div>                                                
                        </div>
                        <a href="http://allexamcorner.com/#contact" class="btn btn-warning btn-lg btn-block">Contact Us</a>
                    </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">        
                    <div class="price_table_container">
                        <div class="price_table_heading">Standard</div>
                        <div class="price_table_body">
                            <div class="price_table_row cost primary-bg"><strong>Rs 10,000</strong><span> / Save 50%</span></div>
                            <div class="price_table_row">1 Websites</div>
                            <div class="price_table_row">Rs 299.50 / month Hosting</div>
                            <div class="price_table_row">Unmetered Storage</div>
                            <div class="price_table_row">Unmetered  Bandwidth</div>
                            <div class="price_table_row">Free domain* with annual plan</div>
                            <div class="price_table_row">Free Personal/Business Email - 1st year</div>
                            <div class="price_table_row">Full Time Support</div>                                                      
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">        
                    <div class="price_table_container">
                        <div class="price_table_heading">Advance</div>
                        <div class="price_table_body">
                             <div class="price_table_row cost primary-bg"><strong>Rs 15,000</strong><span> / Save 50%</span></div>
                            <div class="price_table_row">1 Websites</div>
                            <div class="price_table_row">Rs 499.50 / month Hosting</div>
                            <div class="price_table_row">Unmetered Storage</div>
                            <div class="price_table_row">Unmetered  Bandwidth</div>
                            <div class="price_table_row">Free domain* with annual plan</div>
                            <div class="price_table_row">Free Personal/Business Email - 1st year</div>
                            <div class="price_table_row">Free SEO</div>   
                            <div class="price_table_row">Full Time Support</div>  
